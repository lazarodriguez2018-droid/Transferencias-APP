...
const sourceSheet=XLSX.utils.aoa_to_sheet([
  ...
  ['00123','MDO','Producto uno',10,'PDE','1:4:0:0',20,null],
  ['B2','MDO','Producto dos',2,'PDE','1:4:0:0',4,null],
...
assert.strictEqual(processedSheet.A2.v,'00123');
assert.strictEqual(processedSheet.A3.v,'B2');
...
assert.strictEqual(processedSheet.H2.v,10);
