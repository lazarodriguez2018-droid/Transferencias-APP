(function(root){
  ...
  function renderFilters(){
    ...
    $('session-filter-body').innerHTML=`<label>Local<select id="session-location-filter" data-filter="local">${selectOptions(locals,f.local,'Todos mis locales')}</select></label>
      ...
      <label>Usuario o invitado<select data-filter="user">${selectOptions(users,f.user,'Todas las personas')}</select></label><p class="directory-hint">Incluye al creador y a quienes participaron.</p>
