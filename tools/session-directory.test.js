...
assert.match(html,/session-directory.js\?v=expected-v1/);assert.match(css,/max-width:1760px!important/);assert.match(css,/prefers-reduced-motion/);assert.match(css,/100dvh/);
