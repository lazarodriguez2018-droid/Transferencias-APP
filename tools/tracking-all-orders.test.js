...
assert.match(index,/app\.js\?v=tracking-all-orders-v2/,'La publicación debe invalidar el JavaScript anterior del navegador');
assert.match(index,/style\.css\?v=tracking-all-orders-v3/,'La publicación debe invalidar los estilos anteriores del navegador');
