...
assert.match(operationsHtml,/reposition-app\.js\?v=supervision-mode-v1/,'La sesión normal debe invalidar el JavaScript anterior');
assert.match(guestHtml,/invitado\.js\?v=reposition-control-v2/,'La sesión QR debe invalidar el JavaScript anterior');
